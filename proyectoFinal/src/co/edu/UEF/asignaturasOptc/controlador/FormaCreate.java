...
public class FormaCreate {
	...
	Clase[] clases_disponibles= {Fisica,Frances, Calculo, Elementos, Paradigmas2,Paradigmas,
			Create, Estructuras};
	ImpleCRUD clases = new ImpleCRUD();   private Parent root;
   	private Stage stage;
    ...
    @FXML
    private ChoiceBox<Integer> ChoiceCreate;
    ...
    ObservableList<Integer>list= FXCollections.observableArrayList();
   	...
   	public void inicializar (URL arg0, ResourceBundle arg1) {
   		...
   		Clase[][] clases_agregadas = clases.getHorario();
   		
   		for (int i = 0; i < clases_agregadas.length; i++) {
   			
   				for (int j = 0; j < clases_agregadas[0].length; j++) {
   		    		list.add(clases_agregadas[i][j].getCosto());			
   				}
