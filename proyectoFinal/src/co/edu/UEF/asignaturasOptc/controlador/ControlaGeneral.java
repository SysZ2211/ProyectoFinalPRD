...
public class ControlaGeneral {
    ...
    ImpleCRUD horario = new ImpleCRUD();
    ...
    void pressCreate(ActionEvent event) {
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/edu/UEF/asignaturasOptc/vista/pantallaCreate.fxml"));
    	try {
        	root = loader.load();
    	...
    	FormaCreate create = loader.getController();
    	
    	//create.start(horario);
    ...
    void pressReadAll(ActionEvent event) {
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/edu/UEF/asignaturasOptc/vista/pantallaReadAll.fxml"));
    	try {
    	...
    	FormaReadAll cr = loader.getController();
    ...
    void pressDelete(ActionEvent event) {
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("/co/edu/UEF/asignaturasOptc/vista/pantallaDelete.fxml"));
    	try {
        	root = loader.load();
        	stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        	Scene scene = new Scene (root);
    	...
    	FormaDelete delete = loader.getController();
    	
    	//delete.start(horario);
    }
    @FXML
